...
st.sidebar.markdown('Desenvolvido por [Rogério Guilherme Jr.]')

if 'data' not in st.session_state:
    df_data = pd.read_csv( r'C:\Users\Roger\PyCharmMiscProject\Streamlit\Projeto Streamlit FIFA\datasets\CLEAN_FIFA23_official_data.csv', index_col=0)
